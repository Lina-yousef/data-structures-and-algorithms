...
const typeNum = (arr) => {
  // Solution code here...
  let numbers = arr.filter(function (i){
    return (parseInt(i) === i);
  });
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArr = arr.filter(str => str.match(/and/gi));
  return newArr ;
};
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let vowelArr = arr.filter(str => /[aeiou]/g.test(str));
  return vowelArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let i = arr.filter(element=> !forbiddenValues.includes(element));
  return i;
};
